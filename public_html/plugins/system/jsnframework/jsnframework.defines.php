...
define('JSN_FRAMEWORK_VERSION',			'1.3.2');
...
JSNHtmlAsset::addScriptLibrary('jquery.wysiwyg.colorpicker','3rd-party/jquery-jwysiwyg/controls/wysiwyg.colorpicker',					array('jquery','jquery.jwysiwyg'));
JSNHtmlAsset::addScriptLibrary('jquery.wysiwyg.table',		'3rd-party/jquery-jwysiwyg/controls/wysiwyg.table',							array('jquery','jquery.jwysiwyg'));
JSNHtmlAsset::addScriptLibrary('jquery.wysiwyg.cssWrap',	'3rd-party/jquery-jwysiwyg/controls/wysiwyg.cssWrap',						array('jquery','jquery.jwysiwyg'));
JSNHtmlAsset::addScriptLibrary('jquery.wysiwyg.image',		'3rd-party/jquery-jwysiwyg/controls/wysiwyg.image',							array('jquery','jquery.jwysiwyg'));
JSNHtmlAsset::addScriptLibrary('jquery.wysiwyg.link',		'3rd-party/jquery-jwysiwyg/controls/wysiwyg.link',							array('jquery','jquery.jwysiwyg'));
